...
DROP DATABASE IF EXISTS BI_Bikes_50;
DROP DATABASE IF EXISTS BI_BikesDW_50;
CREATE DATABASE IF NOT EXISTS BI_Bikes_50;
CREATE DATABASE IF NOT EXISTS BI_BikesDW_50; 
